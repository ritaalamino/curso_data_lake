...
def create_url():
    ...
    filters = "start_time=2022-06-08T00:00:00Z&end_time=2022-06-14T00:00:00Z"
...
def paginate(url, headers, next_token=None):
    if next_token:
        full_url = f"{url}&next_token={next_token}"	# Add the next token to the URL
    else:
        full_url = url
